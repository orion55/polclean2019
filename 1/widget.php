...
class Accordeonmenuck_Widget extends WP_Widget
{
    ...
    function form($instance)
    {
        ...
        <p><input id="<?php echo $this->get_field_id('hide_title'); ?>"
                  name="<?php echo $this->get_field_name('hide_title'); ?>"
                  type="checkbox" <?php checked(isset($instance['hide_title']) ? $instance['hide_title'] : 0); ?> />&nbsp;<label
                    for="<?php echo $this->get_field_id('hide_title'); ?>"><?php _e('Hide title if menu is empty', 'accordeon-menu-ck'); ?></label>
        </p>

        <fieldset class="ck">
            <legend><?php _e('Menu', 'accordeon-menu-ck'); ?></legend>
            <p>
                <label for="<?php echo $this->get_field_id('nav_menu'); ?>"><?php _e('Select Menu', 'accordeon-menu-ck'); ?>
                    : </label>
            ...
            <p>
                ...
                <select name="<?php echo $this->get_field_name('depth'); ?>"
                        id="<?php echo $this->get_field_id('depth'); ?>" class="widefat">
            ...
            <p>
                <input id="<?php echo $this->get_field_id('description'); ?>"
                       ...
                       type="checkbox" <?php checked(isset($instance['description']) ? $instance['description'] : 0); ?> />&nbsp;<label
                        for="<?php echo $this->get_field_id('description'); ?>"><?php _e('Include descriptions', 'accordeon-menu-ck'); ?></label>
            </p>

            <p>
                <label for="<?php echo $this->get_field_id('menu_class'); ?>"><?php _e('Menu Class', 'accordeon-menu-ck') ?></label>
                <input type="text" class="widefat" id="<?php echo $this->get_field_id('menu_class'); ?>"
                       name="<?php echo $this->get_field_name('menu_class'); ?>" value="<?php echo $menu_class; ?>"/>
        ...
        <fieldset class="ck">
            ...
            <p>
                <label for="<?php echo $this->get_field_id('style'); ?>"><?php _e('Select Style', 'accordeon-menu-ck'); ?>
                    : </label>
                ...
                <span class="button" onclick="ckEditStyleWidget(this)"><img
                            src="<?php echo CEIKAY_MEDIA_URL ?>/images/pencil.png"/><?php _e('Edit the style', 'accordeon-menu-ck') ?></span>
                <br/><a href="admin.php?page=accordeonmenuck_general">
                    <small><?php _e('You can create a new style in the Accordeon Menu CK plugin', 'accordeon-menu-ck'); ?></small>
                </a>
            </p>
        </fieldset>
        <fieldset class="ck">
            ...
            <p>
                ...
                <select name="<?php echo $this->get_field_name('transition'); ?>"
                        id="<?php echo $this->get_field_id('transition'); ?>" class="">
                    ...
                    <option value="easeInOutCubic"<?php selected($transition, 'easeInOutCubic'); ?>>easeInOutCubic
                    </option>
                    ...
                    <option value="easeInOutQuart"<?php selected($transition, 'easeInOutQuart'); ?>>easeInOutQuart
                    </option>
                    ...
                    <option value="easeInOutQuint"<?php selected($transition, 'easeInOutQuint'); ?>>easeInOutQuint
                    </option>
                    ...
                    <option value="easeOutElastic"<?php selected($transition, 'easeOutElastic'); ?>>easeOutElastic
                    </option>
                    <option value="easeInOutElastic"<?php selected($transition, 'easeInOutElastic'); ?>>
                        easeInOutElastic
                    </option>
                    ...
                    <option value="easeInOutBounce"<?php selected($transition, 'easeInOutBounce'); ?>>easeInOutBounce
                    </option>
                </select>
            </p>
            <p>
                <label for="<?php echo $this->get_field_id('duration'); ?>"><?php _e('Duration', 'accordeon-menu-ck') ?></label>
                <input type="text" class="" id="<?php echo $this->get_field_id('duration'); ?>"
                       name="<?php echo $this->get_field_name('duration'); ?>" value="<?php echo $duration; ?>"/> ms
            </p>
            <p>
                ...
                <select name="<?php echo $this->get_field_name('eventtype'); ?>"
                        id="<?php echo $this->get_field_id('eventtype'); ?>" class="">
